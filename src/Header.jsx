...
// import CartModel from './CartModel'; // Adjust path as per your project structure

// const Header = ({ cart = [], updateQuantity, removeFromCart, total, theme, toggleTheme }) => {
//     const [isCartOpen, setIsCartOpen] = useState(false);

//     console.log('Cart in Header:', cart); // Debug log

//     return (
//         <header className={`p-3 mb-8 shadow ${theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-black"}`}>
//             <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
//                 <h1 className={`text-2xl font-bold flex items-center gap-4 ${theme === "dark" ? "text-white" : "text-gray-800"}`}>
...
import React, { useState } from 'react';
import { FaShoppingCart, FaSun, FaMoon, FaStore } from 'react-icons/fa';
import CartModel from './Components/CartModel'; // Adjust path as per your Rica project structure
