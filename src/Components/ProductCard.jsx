...
//           </span>
//           <button className="bg-blue-600 text-white px-3 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-all duration-300 ease-in-out" onClick={addToCart(product)}>
