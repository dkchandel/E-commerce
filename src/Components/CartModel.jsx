...
const CartModel = ({ cart, updateQuantity, removeFromCart, total, onClose, theme }) => {
    const handleQuantityChange = (id, change) => {
        ...
        if (newQuantity < 1) {
            removeFromCart(id); // Remove item if quantity becomes 0
        } else {
            updateQuantity(id, newQuantity); // Update to new quantity
        }
    };
                            ...
                            <div key={item.id}
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        <button className={`p-1 ${theme === "dark" ? "bg-gray-700 hover:bg-gray-600" : "bg-gray-200 hover:bg-gray-300"} rounded`}
                                ...
                                <button className={`p-2 text-red-500 hover:text-red-600 ${theme === "dark" ? "text-red-400" : "text-red-500"}`}
