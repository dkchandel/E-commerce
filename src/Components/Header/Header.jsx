...
// import {FaShoppingCart, FaSun, FaMoon, FaStore, FaShapes} from "react-icons/fa"
...
//   return (
//        <header className={`p-3 mb-8 shadow === "dark" ? "bg-gray-800 text-white" : "bg-white text-black"`}>
